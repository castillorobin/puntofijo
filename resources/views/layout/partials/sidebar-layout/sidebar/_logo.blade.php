...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
    ...
    <a href="/" class="d-flex align-items-center text-white text-decoration-none">
        <img alt="Logo" src="{{ asset('fotos/logo.png') }}" class="h-25px app-sidebar-logo-default me-2" />
        <img alt="Logo" src="{{ asset('fotos/logo.png') }}" class="h-20px app-sidebar-logo-minimize me-2" />
        <span class="fw-bold">Melo Express</span>
    </a>
