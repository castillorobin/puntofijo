...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Set the name of the store" data-bs-original-title="Set the name of the store" data-kt-initialized="1">
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Set the store owner's name" data-bs-original-title="Set the store owner's name" data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Set the store's full address." data-bs-original-title="Set the store's full address." data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Enter the store geocode manually (optional)" data-bs-original-title="Enter the store geocode manually (optional)" data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<form id="kt_ecommerce_settings_general_localization" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
    ...
    <div class="row fv-row mb-7 fv-plugins-icon-container">
        ...
        <div class="col-md-9">
            ...
            <select id="kt_ecommerce_localization_country" class="form-select form-select-solid select2-hidden-accessible" name="localization_country" data-kt-ecommerce-settings-type="select2_flags" data-placeholder="Select a country" data-select2-id="select2-data-kt_ecommerce_localization_country" tabindex="-1" aria-hidden="true">
                <option data-select2-id="select2-data-136-yvu9"></option>
    ...
    <div class="row fv-row mb-7 fv-plugins-icon-container">
        ...
        <div class="col-md-9">
            <div class="w-100">
                <!--begin::Select2-->
                <select class="form-select form-select-solid select2-hidden-accessible" name="localization_language" data-control="select2" data-placeholder="Select a language" data-select2-id="select2-data-15-59ml" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                    <option data-select2-id="select2-data-17-w2e8"></option>
                                    ...
                                    </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-16-ks5m" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-localization_language-qp-container" aria-controls="select2-localization_language-qp-container"><span class="select2-selection__rendered" id="select2-localization_language-qp-container" role="textbox" aria-readonly="true" title="Select a language"><span class="select2-selection__placeholder">Select a language</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                <!--end::Select2-->
            </div>
        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>
    </div>
    ...
    <div class="row fv-row mb-7 fv-plugins-icon-container">
        ...
        <div class="col-md-9">
            <div class="w-100">
                <!--begin::Select2-->
                <select class="form-select form-select-solid select2-hidden-accessible" name="localization_currency" data-control="select2" data-hide-search="true" data-placeholder="Select a currency" data-select2-id="select2-data-18-nvp9" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                    <option data-select2-id="select2-data-20-13bk"></option>
                ...
                </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-19-kd6v" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-localization_currency-bu-container" aria-controls="select2-localization_currency-bu-container"><span class="select2-selection__rendered" id="select2-localization_currency-bu-container" role="textbox" aria-readonly="true" title="Select a currency"><span class="select2-selection__placeholder">Select a currency</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                <!--end::Select2-->
            </div>
        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>
    </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Set the unit measurement for length." data-bs-original-title="Set the unit measurement for length." data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
        ...
        <div class="col-md-9">
            <div class="w-100">
                <!--begin::Select2-->
                <select class="form-select form-select-solid select2-hidden-accessible" name="localization_currency" data-control="select2" data-hide-search="true" data-placeholder="Select a length class" data-select2-id="select2-data-21-sheg" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                    <option></option>
                    <option value="cm" selected="" data-select2-id="select2-data-23-p49p">Centimeter</option>
                    <option value="mm">Milimeter</option>
                    <option value="in">Inch</option>
                </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-22-psh2" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-localization_currency-ku-container" aria-controls="select2-localization_currency-ku-container"><span class="select2-selection__rendered" id="select2-localization_currency-ku-container" role="textbox" aria-readonly="true" title="Centimeter">Centimeter</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                <!--end::Select2-->
            </div>
        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>
    </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Set the unit measurement for weight." data-bs-original-title="Set the unit measurement for weight." data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
        ...
        <div class="col-md-9">
            <div class="w-100">
                <!--begin::Select2-->
                <select class="form-select form-select-solid select2-hidden-accessible" name="localization_currency" data-control="select2" data-hide-search="true" data-placeholder="Select a weight class" data-select2-id="select2-data-24-yfw8" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                    <option></option>
                    <option value="kg" selected="" data-select2-id="select2-data-26-efy6">Kilogram</option>
                    <option value="g">Gram</option>
                    <option value="lb">Pound</option>
                    <option value="oz">Ounce</option>
                </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-25-1fey" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-localization_currency-hq-container" aria-controls="select2-localization_currency-hq-container"><span class="select2-selection__rendered" id="select2-localization_currency-hq-container" role="textbox" aria-readonly="true" title="Kilogram">Kilogram</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                <!--end::Select2-->
            </div>
        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>
    </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Show the number of products inside the subcategories in the storefront header category menu. Be warned, this will cause an extreme performance hit for stores with a lot of subcategories!" data-bs-original-title="Show the number of products inside the subcategories in the storefront header category menu. Be warned, this will cause an extreme performance hit for stores with a lot of subcategories!" data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Determines how many items are shown per page." data-bs-original-title="Determines how many items are shown per page." data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Enable/disable review entries for registered customers." data-bs-original-title="Enable/disable review entries for registered customers." data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Enable/disable review entries for public guest customers" data-bs-original-title="Enable/disable review entries for public guest customers" data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Minimum number of vouchers customers can attach to an order" data-bs-original-title="Minimum number of vouchers customers can attach to an order" data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Maximum number of vouchers customers can attach to an order" data-bs-original-title="Maximum number of vouchers customers can attach to an order" data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Determines the tax percentage (%) applied to orders" data-bs-original-title="Determines the tax percentage (%) applied to orders" data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Enable/disable tracking customers online status." data-bs-original-title="Enable/disable tracking customers online status." data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Enable/disable tracking customers activity." data-bs-original-title="Enable/disable tracking customers activity." data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Enable/disable logging customers search keywords." data-bs-original-title="Enable/disable logging customers search keywords." data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Enable/disable guest customers to checkout." data-bs-original-title="Enable/disable guest customers to checkout." data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Only show prices when customers log in." data-bs-original-title="Only show prices when customers log in." data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
...
<span class="ms-1" data-bs-toggle="tooltip" aria-label="Set the max number of login attempts before the customer account is locked for 1 hour." data-bs-original-title="Set the max number of login attempts before the customer account is locked for 1 hour." data-kt-initialized="1">
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            <!--end::Label-->
        </div>
